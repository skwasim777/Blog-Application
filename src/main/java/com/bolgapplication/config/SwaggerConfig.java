...
public class SwaggerConfig {
	...
	private ApiInfo getInfo() {
		return new ApiInfo("Blogging Application API",
				"This API provides endpoints for managing a blogging application.", "API v1.0", "Terms of service",
				new Contact("Wasim Shaikh", "https://github.com/skwasim777", "wasimsk6061@gmail.com"), "License of API",
